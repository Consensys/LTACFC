...
public class CrossBlockchainControl extends Contract {
    private static final String BINARY = "";
    ...
    public RemoteCall<BigInteger> timeout(BigInteger param0) {
    ...
    public RemoteCall<TransactionReceipt> segment(BigInteger _startEventBlockHash, byte[] _startEvent) {
    ...
    public RemoteCall<TransactionReceipt> close(BigInteger _startEventBlockHash, byte[] _startEvent) {
        final Function function = new Function(
                FUNC_CLOSE, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(_startEventBlockHash), 
                new org.web3j.abi.datatypes.DynamicBytes(_startEvent)), 
    ...
    public RemoteCall<TransactionReceipt> signalling(BigInteger _startEventBlockHash, byte[] _startEvent) {
        final Function function = new Function(
                FUNC_SIGNALLING, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(_startEventBlockHash), 
                new org.web3j.abi.datatypes.DynamicBytes(_startEvent)), 
    ...
    public RemoteCall<TransactionReceipt> root(BigInteger _startEventBlockHash, byte[] _startEvent) {
        final Function function = new Function(
                FUNC_ROOT, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(_startEventBlockHash), 
                new org.web3j.abi.datatypes.DynamicBytes(_startEvent)), 
    ...
    public RemoteCall<TransactionReceipt> start(BigInteger _crossBlockchainTransactionId, BigInteger _timeout) {
        final Function function = new Function(
                FUNC_START, 
    ...
    public static class StartEventResponse {
        public Log log;
