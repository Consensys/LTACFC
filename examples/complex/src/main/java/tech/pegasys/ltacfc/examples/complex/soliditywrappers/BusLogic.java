...
public class BusLogic extends Contract {
    public static final String BINARY = "";

    public static final String FUNC_STOCKSHIPMENT = "stockShipment";

    public static final Event HELP_EVENT = new Event("Help", 
    ...
    public List<HelpEventResponse> getHelpEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(HELP_EVENT, transactionReceipt);
        ArrayList<HelpEventResponse> responses = new ArrayList<HelpEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            HelpEventResponse typedResponse = new HelpEventResponse();
    ...
    public Flowable<HelpEventResponse> helpEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new Function<Log, HelpEventResponse>() {
            @Override
            public HelpEventResponse apply(Log log) {
                Contract.EventValuesWithLog eventValues = extractEventParametersWithLog(HELP_EVENT, log);
                HelpEventResponse typedResponse = new HelpEventResponse();
    ...
    public Flowable<HelpEventResponse> helpEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(HELP_EVENT));
        return helpEventFlowable(filter);
    }
    ...
    public static class HelpEventResponse extends BaseEventResponse {
        public String _a;
    }
}
